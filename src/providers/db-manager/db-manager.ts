...
export class DbManagerProvider {
    ...
    initTables(db){
        ...
        db.executeSql('CREATE TABLE IF NOT EXISTS WI_ELEMENT_ATTACHMENT (ID_WI_ELEMENT_ATTACHMENT INTEGER PRIMARY KEY, ID_WORK_ITEM_ELEMENT INTEGER,ID_ELEMENT_TYPE_CONFIG_DOC INTEGER,DE_WI_ELEMENT_ATTACHMENT TEXT,VL_FILE_B64 CLOB,FG_SYNCED INTEGER,VL_TYPE TEXT,DT_MODIFIED TEXT)', []);
