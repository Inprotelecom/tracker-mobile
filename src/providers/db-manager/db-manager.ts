...
export class DbManagerProvider {
    ...
    initTables(db){
        ...
        db.executeSql('CREATE TABLE IF NOT EXISTS WI_ELEMENT_ATTRIBUTE (ID_WI_ELEMENT_ATTRIBUTE INTEGER, ID_ATTRIBUTE INTEGER, VL_ATTRIBUTE TEXT, ID_WORK_ITEM_ELEMENT INTEGER, PRIMARY KEY(ID_ATTRIBUTE,ID_WORK_ITEM_ELEMENT) )', []);
    }
